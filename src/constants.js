...
export const ourvisionText =
  "We are creating a groundbreaking media outlet to empower creators and artists. As an owner of The Tarnished you'll receive the world's first truly dynamic-form NFT, exclusive access to Eden (VIP members only club) and will help direct the development of our submervise world.";
export const meetToulText1 =
